...
def ouvrir_menu_pieces(page: Page):
    """Déplie la section 'Pièces' du menu latéral (repliée par défaut)."""
    page.get_by_role("button", name="Pièces").click()
